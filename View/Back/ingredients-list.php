    ...
    <div class="p-8 max-w-7xl mx-auto space-y-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-zinc-100 p-5 flex flex-col lg:flex-row gap-4 lg:items-center lg:justify-between">
            ...
            <div class="flex items-center gap-3 text-sm text-zinc-500">
                ...
                <span id="ingredient-visible-count" class="rounded-full bg-green-50 px-3 py-1 font-bold text-primary"><?php echo count($ingredients); ?></span>
            </div>
        </div>
        ...
        <div class="flex items-center justify-between">
            <p class="text-sm text-zinc-500">
                ...
                &mdash; <?php echo $totalCount; ?> ingrédients au total
            </p>
            <nav class="flex items-center gap-1">
                <?php if ($currentPage > 1): ?>
                    <a href="index.php?action=admin-ingredients&amp;section=ingredient&amp;page=<?php echo $currentPage - 1; ?>"
                       class="px-3 py-2 rounded-lg border border-zinc-200 hover:bg-zinc-50 text-sm font-medium">&lsaquo;</a>
                <?php endif; ?>
                <?php for ($p = max(1, $currentPage - 2); $p <= min($totalPages, $currentPage + 2); $p++): ?>
                    <a href="index.php?action=admin-ingredients&amp;section=ingredient&amp;page=<?php echo $p; ?>"
